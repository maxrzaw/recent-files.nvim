...
describe("worktree_oldfiles.logic", function()
    ...
    describe("dedupe_key", function()
        it("uses related worktrees and relative path for git records", function()
    ...
    describe("display_dedupe_key", function()
        ...
        it("dedupes sibling worktrees across related worktrees", function()
        ...
        it("keeps sibling worktrees distinct outside related worktrees", function()
            local key = logic.display_dedupe_key(record, {
    ...
    describe("should_translate_to_context", function()
        ...
        it("translates equivalent files across related worktrees", function()
        ...
        it("does not translate equivalent files outside related worktrees", function()
    ...
    describe("pick_representatives", function()
        it("dedupes git records by related worktrees and relative path", function()
            local records = {
                {
